...
% pesti.m
%
% Model exported on Jan 12 2021, 21:25 by COMSOL 5.2.1.152.
...
model.comments(['Pesticide Transport and Reaction in ction.']);
...
model.func('int1').set('funcs', {'inta' '1'; 'intasn' '2'; 'intasx' '3'});
model.func('int1').set('nargs', '2');
model.func('int1').set('argunit', 'm');
model.func('int1').set('filename', 'F:\Pycharm\COMSOL_phreeqc\Result\initconi.txt');
...
model.func('int2').set('filename', 'F:\Pycharm\COMSOL_phreeqc\Result/flowhi.txt');
model.func('int2').set('source', 'file');
model.func('int2').set('funcs', {'inth' '1'});
model.func('int2').set('fununit', 'm');
model.func('int2').set('nargs', '2');
model.func('int3').model('comp1');
model.func('int3').set('argunit', 'm');
model.func('int3').set('frame', 'mesh');
model.func('int3').set('defvars', 'on');
model.func('int3').set('filename', 'F:\Pycharm\COMSOL_phreeqc\Result/flowthei.txt');
model.func('int3').set('source', 'file');
model.func('int3').set('funcs', {'intthe' '1'});
model.func('int3').set('fununit', '1');
...
model.view('view1').axis.set('ymax', '0.1247439980506897');
model.view('view1').axis.set('ymin', '-1.424743890762329');
...
model.physics('dl').feature('init1').set('Hp', 'inth');
...
model.physics('tds').feature('init1').set('initc', {'inta'; 'intasx'; 'intasn'});
